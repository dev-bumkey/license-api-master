...
public class Scanner {
   ...
   * @return name
  **/
  @Schema(example = "Trivy", description = "Name of the scanner")
   ...
   * @return vendor
  **/
  @Schema(example = "Aqua Security", description = "Name of the scanner provider")
   ...
   * @return version
  **/
  @Schema(example = "v0.9.1", description = "Version of the scanner adapter")
