...
import run.acloud.commons.client.harbor.v2.model.WebhookJob;
...
public class WebhookjobApi {
    ...
    public WebhookjobApi(HarborApiClientV2 apiClient) {
    ...
    private Call listWebhookJobsValidateBeforeCall(String projectNameOrId, Long policyId, String xRequestId, Boolean xIsResourceName, String q, String sort, Long page, Long pageSize, List<String> status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        Call call = listWebhookJobsCall(projectNameOrId, policyId, xRequestId, xIsResourceName, q, sort, page, pageSize, status, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<List<WebhookJob>> listWebhookJobsWithHttpInfo(String projectNameOrId, Long policyId, String xRequestId, Boolean xIsResourceName, String q, String sort, Long page, Long pageSize, List<String> status) throws ApiException {
        Call call = listWebhookJobsValidateBeforeCall(projectNameOrId, policyId, xRequestId, xIsResourceName, q, sort, page, pageSize, status, null, null);
     ...
     */
    public Call listWebhookJobsAsync(String projectNameOrId, Long policyId, String xRequestId, Boolean xIsResourceName, String q, String sort, Long page, Long pageSize, List<String> status, final ApiCallback<List<WebhookJob>> callback) throws ApiException {
        ...
        Call call = listWebhookJobsValidateBeforeCall(projectNameOrId, policyId, xRequestId, xIsResourceName, q, sort, page, pageSize, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<WebhookJob>>(){}.getType();
