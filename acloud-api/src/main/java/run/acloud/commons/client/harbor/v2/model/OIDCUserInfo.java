...
public class OIDCUserInfo {
   ...
   * @return id
  **/
  @Schema(description = "the ID of the OIDC info record")
  ...
  **/
   ...
   * @return subiss
  **/
  @Schema(description = "the concatenation of sub and issuer in the ID token")
   ...
   * @return secret
  **/
  @Schema(description = "the secret of the OIDC user that can be used for CLI to push/pull artifacts")
   ...
   * @return creationTime
  **/
  @Schema(description = "The creation time of the OIDC user info record.")
   ...
   * @return updateTime
  **/
  @Schema(description = "The update time of the OIDC user info record.")
