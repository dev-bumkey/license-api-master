...
public class Project {
  ...
  @Schema(description = "The role ID with highest permission of the current user who triggered the API (for UI)")
  ...
  @Schema(description = "The CVE whitelist of this project.")
