...
public class Project {
  ...
  **/
   ...
   * @return registryId
  **/
  @Schema(description = "The ID of referenced registry when the project is a proxy cache project.")
  ...
  **/
  ...
  public Project updateTime(OffsetDateTime updateTime) {
  ...
  **/
  @Schema(description = "The role ID with highest permission of the current user who triggered the API (for UI).  This attribute is deprecated and will be removed in future versions.")
  ...
  **/
  @Schema(description = "The list of role ID of the current user who triggered the API (for UI)")
  ...
  **/
   ...
   * @return cveAllowlist
  **/
  @Schema(description = "The CVE allowlist of this project.")
