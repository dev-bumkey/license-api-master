...
public class GeneralInfo {
  ...
  public GeneralInfo currentTime(OffsetDateTime currentTime) {
   ...
   * @return currentTime
  **/
  @Schema(description = "The current time of the server.")
  ...
  **/
  @Schema(description = "If the Harbor instance is deployed with nested chartmuseum.")
  ...
  **/
  @Schema(description = "The storage provider's name of Harbor registry")
  ...
  **/
  @Schema(description = "The flag to indicate whether notification mechanism is enabled on Harbor instance.")
  ...
  **/
  @Schema(description = "The setting of auth proxy this is only available when Harbor relies on authproxy for authentication.")
