...
public class Configurations {
   ...
   * @return authMode
  **/
  @Schema(description = "The auth mode of current system, such as 'db_auth', 'ldap_auth', 'oidc_auth'")
  ...
  **/
  ...
  public Configurations emailPassword(String emailPassword) {
  ...
  **/
  @Schema(description = "Email password")
  ...
  **/
   ...
   * @return ldapFilter
  **/
  @Schema(description = "The filter for LDAP search")
  ...
  **/
  @Schema(description = "The scope to search ldap group. ''0-LDAP_SCOPE_BASE, 1-LDAP_SCOPE_ONELEVEL, 2-LDAP_SCOPE_SUBTREE''")
   ...
   * @return ldapScope
  **/
  @Schema(description = "The scope to search ldap users,'0-LDAP_SCOPE_BASE, 1-LDAP_SCOPE_ONELEVEL, 2-LDAP_SCOPE_SUBTREE'")
  ...
  **/
  @Schema(description = "The password of the ldap search dn")
  ...
  **/
  @Schema(description = "The user attribute to identify the group membership")
  ...
  **/
   ...
   * @return readOnly
  **/
  @Schema(description = "The flag to indicate whether Harbor is in readonly mode.")
  ...
  **/
   ...
   * @return uaaClientId
  **/
  @Schema(description = "The client id of UAA")
  ...
  **/
  @Schema(description = "The client secret of the UAA")
   ...
   * @return uaaEndpoint
  **/
  @Schema(description = "The endpoint of the UAA")
  ...
  **/
  @Schema(description = "Verify the certificate in UAA server")
  ...
  **/
  @Schema(description = "The endpoint of the HTTP auth")
  ...
  **/
  @Schema(description = "The token review endpoint")
  ...
  **/
  @Schema(description = "The group which has the harbor admin privileges")
  ...
  **/
  @Schema(description = "The username which has the harbor admin privileges")
  ...
  **/
  @Schema(description = "Verify the HTTP auth provider's certificate")
  ...
  **/
  @Schema(description = "Search user before onboard")
  ...
  **/
  @Schema(description = "The certificate of the HTTP auth provider")
   ...
   * @return oidcName
  **/
  @Schema(description = "The OIDC provider name")
   ...
   * @return oidcEndpoint
  **/
  @Schema(description = "The endpoint of the OIDC provider")
   ...
   * @return oidcClientId
  **/
  @Schema(description = "The client ID of the OIDC provider")
  ...
  **/
  @Schema(description = "The OIDC provider secret")
  ...
  **/
  @Schema(description = "The attribute claims the group name")
  ...
  **/
  @Schema(description = "The OIDC group which has the harbor admin privileges")
   ...
   * @return oidcScope
  **/
  @Schema(description = "The scope of the OIDC provider")
  ...
  **/
  @Schema(description = "The attribute claims the username")
  ...
  **/
  @Schema(description = "Verify the OIDC provider's certificate'")
  ...
  **/
  @Schema(description = "Auto onboard the OIDC user")
  ...
  **/
  @Schema(description = "Extra parameters to add when redirect request to OIDC provider")
  ...
  **/
  @Schema(description = "The robot account token duration in days")
  ...
  **/
  @Schema(description = "The rebot account name prefix")
  ...
  **/
  @Schema(description = "Enable quota per project")
  ...
  **/
  @Schema(description = "The storage quota per project")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.authMode, configurations.authMode) &&
        ...
        Objects.equals(this.emailPassword, configurations.emailPassword) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authMode, emailFrom, emailHost, emailIdentity, emailInsecure, emailPassword, emailPort, emailSsl, emailUsername, ldapBaseDn, ldapFilter, ldapGroupBaseDn, ldapGroupAdminDn, ldapGroupAttributeName, ldapGroupSearchFilter, ldapGroupSearchScope, ldapScope, ldapSearchDn, ldapSearchPassword, ldapTimeout, ldapUid, ldapUrl, ldapVerifyCert, ldapGroupMembershipAttribute, projectCreationRestriction, readOnly, selfRegistration, tokenExpiration, uaaClientId, uaaClientSecret, uaaEndpoint, uaaVerifyCert, httpAuthproxyEndpoint, httpAuthproxyTokenreviewEndpoint, httpAuthproxyAdminGroups, httpAuthproxyAdminUsernames, httpAuthproxyVerifyCert, httpAuthproxySkipSearch, httpAuthproxyServerCertificate, oidcName, oidcEndpoint, oidcClientId, oidcClientSecret, oidcGroupsClaim, oidcAdminGroup, oidcScope, oidcUserClaim, oidcVerifyCert, oidcAutoOnboard, oidcExtraRedirectParms, robotTokenDuration, robotNamePrefix, notificationEnable, quotaPerProjectEnable, storagePerProject);
  }
