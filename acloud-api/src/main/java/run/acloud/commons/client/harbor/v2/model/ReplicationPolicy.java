...
public class ReplicationPolicy {
  ...
  **/
   ...
   * @return srcRegistry
  **/
  @Schema(description = "The source registry.")
   ...
   * @return destRegistry
  **/
  @Schema(description = "The destination registry.")
  ...
  **/
  @Schema(description = "The destination namespace.")
  ...
  **/
  @Schema(description = "Specify how many path components will be replaced by the provided destination namespace. The default value is -1 in which case the legacy mode will be applied.")
  ...
  **/
   ...
   * @return deletion
  **/
  @Schema(description = "Deprecated, use 'replicate_deletion' instead. Whether to replicate the deletion operation.")
   ...
   * @return override
  **/
  @Schema(description = "Whether to override the resources on the destination registry.")
   ...
   * @return enabled
  **/
  @Schema(description = "Whether the policy is enabled or not.")
  ...
  **/
   ...
   * @return speed
  **/
  @Schema(description = "speed limit for each task")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, srcRegistry, destRegistry, destNamespace, destNamespaceReplaceCount, trigger, filters, replicateDeletion, deletion, override, enabled, creationTime, updateTime, speed);
  }
