...
public class Task {
   ...
   * @return id
  **/
  @Schema(description = "The ID of task")
   ...
   * @return executionId
  **/
  @Schema(description = "The ID of task execution")
   ...
   * @return status
  **/
  @Schema(description = "The status of task")
  ...
  **/
  @Schema(description = "The status message of task")
   ...
   * @return runCount
  **/
  @Schema(description = "The count of task run")
  ...
  **/
   ...
   * @return creationTime
  **/
  @Schema(description = "The creation time of task")
   ...
   * @return updateTime
  **/
  @Schema(description = "The update time of task")
   ...
   * @return startTime
  **/
  @Schema(description = "The start time of task")
   ...
   * @return endTime
  **/
  @Schema(description = "The end time of task")
