...
public class PreheatPolicy {
   ...
   * @return id
  **/
  @Schema(description = "The ID of preheat policy")
   ...
   * @return name
  **/
  @Schema(description = "The Name of preheat policy")
   ...
   * @return description
  **/
  @Schema(description = "The Description of preheat policy")
   ...
   * @return projectId
  **/
  @Schema(description = "The ID of preheat policy project")
   ...
   * @return providerId
  **/
  @Schema(description = "The ID of preheat policy provider")
   ...
   * @return providerName
  **/
  @Schema(description = "The Name of preheat policy provider")
   ...
   * @return filters
  **/
  @Schema(description = "The Filters of preheat policy")
   ...
   * @return trigger
  **/
  @Schema(description = "The Trigger of preheat policy")
   ...
   * @return enabled
  **/
  @Schema(description = "Whether the preheat policy enabled")
   ...
   * @return creationTime
  **/
  @Schema(description = "The Create Time of preheat policy")
   ...
   * @return updateTime
  **/
  @Schema(description = "The Update Time of preheat policy")
