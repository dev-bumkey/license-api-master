...
public class ProjectMetadata {
  ...
  **/
  @Schema(description = "Whether cosign content trust is enabled or not. If it is enabled, user can't pull images without cosign signature from this project. The valid values are 'true', 'false'.")
  ...
  **/
  @Schema(description = "Whether this project reuse the system level CVE allowlist as the allowlist of its own.  The valid values are 'true', 'false'. If it is set to 'true' the actual allowlist associate with this project, if any, will be ignored.")
   ...
   * @return retentionId
  **/
  @Schema(description = "The ID of the tag retention policy for the project")
