...
public class ConfigurationsResponse {
  ...
  **/
  @Schema(description = "The usernames which has the harbor admin privileges")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authMode, emailFrom, emailHost, emailIdentity, emailInsecure, emailPort, emailSsl, emailUsername, ldapBaseDn, ldapFilter, ldapGroupBaseDn, ldapGroupAdminDn, ldapGroupAttributeName, ldapGroupSearchFilter, ldapGroupSearchScope, ldapScope, ldapSearchDn, ldapTimeout, ldapUid, ldapUrl, ldapVerifyCert, ldapGroupMembershipAttribute, projectCreationRestriction, readOnly, selfRegistration, tokenExpiration, uaaClientId, uaaClientSecret, uaaEndpoint, uaaVerifyCert, httpAuthproxyEndpoint, httpAuthproxyTokenreviewEndpoint, httpAuthproxyAdminGroups, httpAuthproxyAdminUsernames, httpAuthproxyVerifyCert, httpAuthproxySkipSearch, httpAuthproxyServerCertificate, oidcName, oidcEndpoint, oidcClientId, oidcGroupsClaim, oidcAdminGroup, oidcScope, oidcUserClaim, oidcVerifyCert, oidcAutoOnboard, oidcExtraRedirectParms, robotTokenDuration, robotNamePrefix, notificationEnable, quotaPerProjectEnable, storagePerProject, scanAllPolicy);
  }
