 ...
 * ProjectMemberEntity
 */
@Schema(title="Harbor Project Member Model", description="Harbor Project Member Model")
public class HarborProjectMemberVO {
  @SerializedName("id")
  ...
  private String entityPassword = null;
  ...
  public HarborProjectMemberVO id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public HarborProjectMemberVO projectId(Integer projectId) {
  ...
  **/
  ...
  public HarborProjectMemberVO entityName(String entityName) {
  ...
  **/
  ...
  public HarborProjectMemberVO entityPassword(String entityPassword) {
    this.entityPassword = entityPassword;
    return this;
  }

   /**
   * the Password of the group member.
   * @return entityPassword
  **/
  @Schema(description = "the Password of the group member.")
  ...
  public HarborProjectMemberVO roleName(String roleName) {
  ...
  **/
  ...
  public HarborProjectMemberVO roleId(Integer roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  **/
  ...
  public HarborProjectMemberVO entityId(Integer entityId) {
   ...
   * @return entityId
  **/
  @Schema(description = "the id of entity, if the member is a user, it is user_id in user table. if the member is a user group, it is the user group's ID in user_group table.")
  ...
  public HarborProjectMemberVO entityType(String entityType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HarborProjectMemberVO projectMemberEntity = (HarborProjectMemberVO) o;
