...
public class ExtensionsV1beta1PodSecurityPolicyList
  ...
  private List<ExtensionsV1beta1PodSecurityPolicy> items =
      new ArrayList<ExtensionsV1beta1PodSecurityPolicy>();
  ...
  public ExtensionsV1beta1PodSecurityPolicyList items(
      List<ExtensionsV1beta1PodSecurityPolicy> items) {

    this.items = items;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicyList addItemsItem(
      ExtensionsV1beta1PodSecurityPolicy itemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ExtensionsV1beta1PodSecurityPolicyList extensionsV1beta1PodSecurityPolicyList =
        (ExtensionsV1beta1PodSecurityPolicyList) o;
