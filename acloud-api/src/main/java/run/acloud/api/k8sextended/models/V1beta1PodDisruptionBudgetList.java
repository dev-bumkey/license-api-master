...
public class V1beta1PodDisruptionBudgetList
  ...
  private List<V1beta1PodDisruptionBudget> items = new ArrayList<>();
   ...
   * @return items
   */
  @Schema(required = true, description = "items list individual PodDisruptionBudget objects")
  ...
  public boolean equals(Object o) {
    ...
    V1beta1PodDisruptionBudgetList v1beta1PodDisruptionBudgetList =
        (V1beta1PodDisruptionBudgetList) o;
