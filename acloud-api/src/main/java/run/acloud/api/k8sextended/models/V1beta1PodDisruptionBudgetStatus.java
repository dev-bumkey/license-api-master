...
public class V1beta1PodDisruptionBudgetStatus {
   ...
   */
  @Schema(required = true, description = "current number of healthy pods")
   ...
   */
  @Schema(required = true, description = "minimum desired number of healthy pods")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conditions, v1beta1PodDisruptionBudgetStatus.conditions)
        ...
        && Objects.equals(
            this.disruptionsAllowed, v1beta1PodDisruptionBudgetStatus.disruptionsAllowed)
        && Objects.equals(this.expectedPods, v1beta1PodDisruptionBudgetStatus.expectedPods)
        && Objects.equals(
            this.observedGeneration, v1beta1PodDisruptionBudgetStatus.observedGeneration);
  }
