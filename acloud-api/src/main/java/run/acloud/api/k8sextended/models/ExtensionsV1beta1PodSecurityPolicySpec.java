...
public class ExtensionsV1beta1PodSecurityPolicySpec {
  ...
  private List<ExtensionsV1beta1AllowedCSIDriver> allowedCSIDrivers = null;
  ...
  private ExtensionsV1beta1FSGroupStrategyOptions fsGroup;
  ...
  private ExtensionsV1beta1SupplementalGroupsStrategyOptions supplementalGroups;
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowPrivilegeEscalation(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedCSIDrivers(
      List<ExtensionsV1beta1AllowedCSIDriver> allowedCSIDrivers) {

    this.allowedCSIDrivers = allowedCSIDrivers;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedCSIDriversItem(
      ExtensionsV1beta1AllowedCSIDriver allowedCSIDriversItem) {
    if (this.allowedCSIDrivers == null) {
      this.allowedCSIDrivers = new ArrayList<ExtensionsV1beta1AllowedCSIDriver>();
    }
  ...
  public void setAllowedCSIDrivers(List<ExtensionsV1beta1AllowedCSIDriver> allowedCSIDrivers) {
    this.allowedCSIDrivers = allowedCSIDrivers;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec allowedCapabilities(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedCapabilitiesItem(
      String allowedCapabilitiesItem) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedFlexVolumes(
      List<ExtensionsV1beta1AllowedFlexVolume> allowedFlexVolumes) {

    this.allowedFlexVolumes = allowedFlexVolumes;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedFlexVolumesItem(
      ExtensionsV1beta1AllowedFlexVolume allowedFlexVolumesItem) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedHostPaths(
      List<ExtensionsV1beta1AllowedHostPath> allowedHostPaths) {

    this.allowedHostPaths = allowedHostPaths;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedHostPathsItem(
      ExtensionsV1beta1AllowedHostPath allowedHostPathsItem) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedProcMountTypes(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedProcMountTypesItem(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedUnsafeSysctls(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedUnsafeSysctlsItem(
      String allowedUnsafeSysctlsItem) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec defaultAddCapabilities(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addDefaultAddCapabilitiesItem(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec defaultAllowPrivilegeEscalation(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addForbiddenSysctlsItem(
      String forbiddenSysctlsItem) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec fsGroup(
      ExtensionsV1beta1FSGroupStrategyOptions fsGroup) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec hostPorts(
      List<ExtensionsV1beta1HostPortRange> hostPorts) {

    this.hostPorts = hostPorts;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec addHostPortsItem(
      ExtensionsV1beta1HostPortRange hostPortsItem) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(description = "privileged determines if a pod can request to be run as privileged.")
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec readOnlyRootFilesystem(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec requiredDropCapabilities(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec addRequiredDropCapabilitiesItem(
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec runAsGroup(
      ExtensionsV1beta1RunAsGroupStrategyOptions runAsGroup) {
  ...
  public void setRunAsGroup(ExtensionsV1beta1RunAsGroupStrategyOptions runAsGroup) {
    this.runAsGroup = runAsGroup;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec runAsUser(
      ExtensionsV1beta1RunAsUserStrategyOptions runAsUser) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec runtimeClass(
      ExtensionsV1beta1RuntimeClassStrategyOptions runtimeClass) {
  ...
  public void setRuntimeClass(ExtensionsV1beta1RuntimeClassStrategyOptions runtimeClass) {
    this.runtimeClass = runtimeClass;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec seLinux(
      ExtensionsV1beta1SELinuxStrategyOptions seLinux) {
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec supplementalGroups(
      ExtensionsV1beta1SupplementalGroupsStrategyOptions supplementalGroups) {
  ...
  public void setSupplementalGroups(
      ExtensionsV1beta1SupplementalGroupsStrategyOptions supplementalGroups) {
    this.supplementalGroups = supplementalGroups;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExtensionsV1beta1PodSecurityPolicySpec extensionsV1beta1PodSecurityPolicySpec =
        (ExtensionsV1beta1PodSecurityPolicySpec) o;
    return Objects.equals(
            this.allowPrivilegeEscalation,
            extensionsV1beta1PodSecurityPolicySpec.allowPrivilegeEscalation)
        && Objects.equals(
            this.allowedCSIDrivers, extensionsV1beta1PodSecurityPolicySpec.allowedCSIDrivers)
        && Objects.equals(
            this.allowedCapabilities, extensionsV1beta1PodSecurityPolicySpec.allowedCapabilities)
        && Objects.equals(
            this.allowedFlexVolumes, extensionsV1beta1PodSecurityPolicySpec.allowedFlexVolumes)
        && Objects.equals(
            this.allowedHostPaths, extensionsV1beta1PodSecurityPolicySpec.allowedHostPaths)
        && Objects.equals(
            this.allowedProcMountTypes,
            extensionsV1beta1PodSecurityPolicySpec.allowedProcMountTypes)
        && Objects.equals(
            this.allowedUnsafeSysctls, extensionsV1beta1PodSecurityPolicySpec.allowedUnsafeSysctls)
        && Objects.equals(
            this.defaultAddCapabilities,
            extensionsV1beta1PodSecurityPolicySpec.defaultAddCapabilities)
        && Objects.equals(
            this.defaultAllowPrivilegeEscalation,
            extensionsV1beta1PodSecurityPolicySpec.defaultAllowPrivilegeEscalation)
        && Objects.equals(
            this.forbiddenSysctls, extensionsV1beta1PodSecurityPolicySpec.forbiddenSysctls)
        ...
        && Objects.equals(
            ...
            extensionsV1beta1PodSecurityPolicySpec.readOnlyRootFilesystem)
        && Objects.equals(
            this.requiredDropCapabilities,
            extensionsV1beta1PodSecurityPolicySpec.requiredDropCapabilities)
        && Objects.equals(this.runAsGroup, extensionsV1beta1PodSecurityPolicySpec.runAsGroup)
        && Objects.equals(this.runAsUser, extensionsV1beta1PodSecurityPolicySpec.runAsUser)
        && Objects.equals(this.runtimeClass, extensionsV1beta1PodSecurityPolicySpec.runtimeClass)
        && Objects.equals(this.seLinux, extensionsV1beta1PodSecurityPolicySpec.seLinux)
        && Objects.equals(
            this.supplementalGroups, extensionsV1beta1PodSecurityPolicySpec.supplementalGroups)
