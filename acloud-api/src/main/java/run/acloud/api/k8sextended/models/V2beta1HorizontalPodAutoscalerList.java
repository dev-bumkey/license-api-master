...
@Schema(description = "HorizontalPodAutoscaler is a list of horizontal pod autoscaler objects.")
...
public class V2beta1HorizontalPodAutoscalerList
  ...
  private List<V2beta1HorizontalPodAutoscaler> items = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    V2beta1HorizontalPodAutoscalerList v2beta1HorizontalPodAutoscalerList =
        (V2beta1HorizontalPodAutoscalerList) o;
