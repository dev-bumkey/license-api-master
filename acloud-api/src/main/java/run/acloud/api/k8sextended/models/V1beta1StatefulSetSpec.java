...
public class V1beta1StatefulSetSpec {
  ...
  private V1beta1StatefulSetUpdateStrategy updateStrategy;
  ...
  public V1beta1StatefulSetSpec volumeClaimTemplates(
  ...
  public V1beta1StatefulSetSpec addVolumeClaimTemplatesItem(
