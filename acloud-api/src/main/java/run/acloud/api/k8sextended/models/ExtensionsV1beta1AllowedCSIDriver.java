...
public class ExtensionsV1beta1AllowedCSIDriver {
   ...
   * @return name
   */
  @Schema(required = true, description = "Name is the registered name of the CSI driver")
  ...
  public boolean equals(Object o) {
    ...
    ExtensionsV1beta1AllowedCSIDriver extensionsV1beta1AllowedCSIDriver =
        (ExtensionsV1beta1AllowedCSIDriver) o;
