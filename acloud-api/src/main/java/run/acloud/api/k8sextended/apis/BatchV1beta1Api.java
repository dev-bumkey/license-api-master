...
import run.acloud.api.k8sextended.models.V1beta1CronJobList;
...
public class BatchV1beta1Api {
   ...
   * </table>
   */
  public V1beta1CronJob createNamespacedCronJob(
      String namespace,
      V1beta1CronJob body,
      String pretty,
      String dryRun,
      ...
      String fieldValidation)
      throws ApiException {
    ApiResponse<V1beta1CronJob> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> createNamespacedCronJobWithHttpInfo(
      String namespace,
      V1beta1CronJob body,
      String pretty,
      String dryRun,
  ...
  public okhttp3.Call createNamespacedCronJobAsync(
      ...
      String fieldManager,
      String fieldValidation,
      final ApiCallback<V1beta1CronJob> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public V1beta1CronJobList listCronJobForAllNamespaces(
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      String labelSelector,
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1beta1CronJobList> localVarResp =
   ...
   * @param watch Watch for changes to the described resources and return them as a stream of add,
   *     update, and remove notifications. Specify resourceVersion. (optional)
   * @return ApiResponse&lt;V1beta1CronJobList&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   * @http.response.details
   *     <table summary="Response Details" border="1">
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJobList> listCronJobForAllNamespacesWithHttpInfo(
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      String labelSelector,
    ...
    okhttp3.Call localVarCall =
        listCronJobForAllNamespacesValidateBeforeCall(
            ...
            watch,
            null);
    Type localVarReturnType = new TypeToken<V1beta1CronJobList>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }
  ...
  public okhttp3.Call listCronJobForAllNamespacesAsync(
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1beta1CronJobList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public V1beta1CronJobList listNamespacedCronJob(
      String namespace,
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJobList> listNamespacedCronJobWithHttpInfo(
      String namespace,
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
   ...
   * </table>
   */
  public V1beta1CronJob patchNamespacedCronJob(
      String name,
      String namespace,
      V1Patch body,
      String pretty,
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> patchNamespacedCronJobWithHttpInfo(
      String name,
      String namespace,
      V1Patch body,
      String pretty,
   ...
   * </table>
   */
  public V1beta1CronJob patchNamespacedCronJobStatus(
      String name,
      String namespace,
      V1Patch body,
      String pretty,
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> patchNamespacedCronJobStatusWithHttpInfo(
      String name,
      String namespace,
      V1Patch body,
      String pretty,
   ...
   * </table>
   */
  public V1beta1CronJob readNamespacedCronJob(String name, String namespace, String pretty)
      throws ApiException {
    ApiResponse<V1beta1CronJob> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> readNamespacedCronJobWithHttpInfo(
  ...
  public okhttp3.Call readNamespacedCronJobAsync(
      String name, String namespace, String pretty, final ApiCallback<V1beta1CronJob> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public V1beta1CronJob readNamespacedCronJobStatus(String name, String namespace, String pretty)
      throws ApiException {
    ApiResponse<V1beta1CronJob> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> readNamespacedCronJobStatusWithHttpInfo(
      String name, String namespace, String pretty) throws ApiException {
    okhttp3.Call localVarCall =
   ...
   * </table>
   */
  public V1beta1CronJob replaceNamespacedCronJob(
      String name,
      String namespace,
      V1beta1CronJob body,
      String pretty,
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> replaceNamespacedCronJobWithHttpInfo(
      String name,
      String namespace,
      V1beta1CronJob body,
      String pretty,
   ...
   * </table>
   */
  public V1beta1CronJob replaceNamespacedCronJobStatus(
      String name,
      String namespace,
      V1beta1CronJob body,
      String pretty,
   ...
   * </table>
   */
  public ApiResponse<V1beta1CronJob> replaceNamespacedCronJobStatusWithHttpInfo(
      String name,
      String namespace,
      V1beta1CronJob body,
      String pretty,
