...
public class V1beta1CustomResourceDefinitionList
  ...
  private List<V1beta1CustomResourceDefinition> items = new ArrayList<>();
  ...
  public V1beta1CustomResourceDefinitionList apiVersion(String apiVersion) {
  ...
  public V1beta1CustomResourceDefinitionList items(List<V1beta1CustomResourceDefinition> items) {

    this.items = items;
    return this;
  }

  public V1beta1CustomResourceDefinitionList addItemsItem(
      V1beta1CustomResourceDefinition itemsItem) {
  ...
  public void setItems(List<V1beta1CustomResourceDefinition> items) {
    this.items = items;
  }

  public V1beta1CustomResourceDefinitionList kind(String kind) {
  ...
  public V1beta1CustomResourceDefinitionList metadata(V1ListMeta metadata) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1CustomResourceDefinitionList v1beta1CustomResourceDefinitionList =
        (V1beta1CustomResourceDefinitionList) o;
  ...
  public String toString() {
    ...
    sb.append("class V1beta1CustomResourceDefinitionList {\n");
