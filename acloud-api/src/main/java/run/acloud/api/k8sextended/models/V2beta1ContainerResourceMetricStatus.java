...
public class V2beta1ContainerResourceMetricStatus {
  ...
  public V2beta1ContainerResourceMetricStatus currentAverageUtilization(
   ...
   * @return name
   */
  @Schema(required = true, description = "name is the name of the resource in question.")
  ...
  public boolean equals(Object o) {
    ...
    V2beta1ContainerResourceMetricStatus v2beta1ContainerResourceMetricStatus =
        (V2beta1ContainerResourceMetricStatus) o;
    return Objects.equals(this.container, v2beta1ContainerResourceMetricStatus.container)
        && Objects.equals(
            this.currentAverageUtilization,
            v2beta1ContainerResourceMetricStatus.currentAverageUtilization)
        && Objects.equals(
            this.currentAverageValue, v2beta1ContainerResourceMetricStatus.currentAverageValue)
        && Objects.equals(this.name, v2beta1ContainerResourceMetricStatus.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(container, currentAverageUtilization, currentAverageValue, name);
  }
