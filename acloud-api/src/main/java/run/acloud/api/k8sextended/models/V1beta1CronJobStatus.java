...
@Schema(description = "CronJobStatus represents the current state of a cron job.")
...
public class V1beta1CronJobStatus {
  ...
  @Schema(description = "A list of pointers to currently running jobs.")
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(description = "Information when was the last time the job successfully completed.")
