...
public class V1beta1ReplicaSetList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1beta1ReplicaSetList metadata(V1ListMeta metadata) {
