...
public class V1beta1CustomResourceColumnDefinition {
  ...
  @Schema(description = "description is a human readable description of this column.")
   ...
   * @return name
   */
  @Schema(required = true, description = "name is a human readable name for the column.")
