...
@Getter
@Setter
@Schema(name = "RoleGuiVO",
        title = "RoleGuiVO",
        description = "Role GUI 모델",
        allOf = {RoleIntegrateVO.class}
)
public class RoleGuiVO extends RoleIntegrateVO {

    @Schema(description = "Cluster Role 이름", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;

    @Schema(description = "Cluster Role namespace", requiredMode = Schema.RequiredMode.REQUIRED)
