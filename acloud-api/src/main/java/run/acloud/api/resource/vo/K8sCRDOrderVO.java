...
@Schema(description = "Cert-Manager CRD Order 모델")
public class K8sCRDOrderVO extends BaseVO {
    ...
    @Schema(title = "challenge", description = "challenge 정보")
    private K8sCRDChallengeVO challenge;
