...
@Schema(name = "LimitRangeYamlVO", title = "LimitRangeYamlVO", allOf = {LimitRangeIntegrateVO.class}, description = "Yaml 배포 모델")
public class LimitRangeYamlVO extends LimitRangeIntegrateVO implements Serializable {

    private static final long serialVersionUID = -3412920959034832014L;
